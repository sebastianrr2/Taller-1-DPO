...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Busca la informacion de un atleta.
	 * @param nombreAtleta El nombre del atleta
	 * @return Un String con el pais correspondiente del nombre del atleta
	 * que se entro por parametro, si no se encuentra el atleta se retorna null.	
	 */
	...
	public String PaisDeUnAtleta(String nombreAtleta)
	{
		...
		if (elAtleta != null)
		{
			...
			resultado = NombrePais.darNombre();
		}
		return resultado;
	}
	/**
