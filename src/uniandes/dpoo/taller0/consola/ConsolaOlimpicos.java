...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un atletas por su nombre");
	...
	/**
	 * Ejecuta la opcion para consultar el pais de un atleta por su nombre.
	 */
	private void ejecutarPaisNombreAtleta() 
	{
		System.out.println("\n" + "Pais del atleta" + "\n");
		
		String nombre = input("Porfavor ingrese el nombre del atleta:");
		String resultado = calculadora.PaisDeUnAtleta(nombre);
		if (resultado == null)
		{
		...
		{
			System.out.println("El pais del atleta "+ nombre +" es: "+ resultado);
		}
